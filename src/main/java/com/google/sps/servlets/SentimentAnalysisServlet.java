...
public class SentimentAnalysisServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    if (score > 0.3) {
        response.getWriter().println("<p>You look like you're having a pretty good day! That's awesome!</p>");
    } else if (score >= -0.3 && score < 0.3) {
        response.getWriter().println("<p>You look like you're having a normal day.</p>");
    } else if (score < -0.3) {
        response.getWriter().println("<p>You look like you're not having a good day. I hope it gets better!</p>");
    }
